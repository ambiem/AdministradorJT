...
public class EmpresaDaoImpl implements EmpresaDao {
	...
	private static final String CONSULTA_SELECT_TODO = "SELECT EMPRESA.ID_EMPRESA, EMPRESA.NOMBRE, EMPRESA.ID_CLIENTE, EMPRESA.FECHA, CLIENTE.NOMBRE FROM EMPRESA, CLIENTE WHERE EMPRESA.ID_CLIENTE = CLIENTE.ID_CLIENTE AND EMPRESA.ACTIVO = 1 ORDER BY EMPRESA.NOMBRE";
